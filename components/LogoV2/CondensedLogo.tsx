...
export function CondensedLogo() {
  ...
  if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
    t5 = <Text bold={true}><Text color="#FF4444">W</Text><Text color="#FF8C00">a</Text><Text color="#FFD700">y</Text><Text color="#44FF44">t</Text><Text color="#00CCFF">o</Text><Text color="#4488FF">A</Text><Text color="#9944FF">G</Text><Text color="#FF44CC">I</Text></Text>;
    $[8] = t5;
  } else {
    t5 = $[8];
  }
